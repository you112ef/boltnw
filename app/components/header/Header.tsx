...
export function Header() {
  ...
  return (
    <header
      className={classNames('flex items-center p-3 sm:p-4 lg:p-5 border-b h-[var(--header-height)]', {
    ...
    >
      ...
      {chat.started && ( // Display ChatDescription and HeaderActionButtons only when the chat has started.
        <>
          <span className="flex-1 px-2 sm:px-4 truncate text-center text-bolt-elements-textPrimary text-xs sm:text-sm">
