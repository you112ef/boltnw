    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary">
        ...
        <a href="/" className="text-2xl font-semibold text-accent flex items-center">
          ...
          <img src="/logo-light-styled.png" alt="logo" className="w-[90px] max-w-[360px]:w-[75px] inline-block dark:hidden" />
          <img src="/logo-dark-styled.png" alt="logo" className="w-[90px] max-w-[360px]:w-[75px] inline-block hidden dark:block" />
        </a>
      </div>
